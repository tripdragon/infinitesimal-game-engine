...
// export class BotStamp extends Tool {
  ...
  update(){
    ...
    // this.visualObject.x = this.system.pointer.worldSpace.x;
    // this.visualObject.y = this.system.pointer.worldSpace.y;
    
    this.visualObject.position.set(this.system.pointer.worldSpace.x, this.system.pointer.worldSpace.y, 0);
  ...
  pointerUp(){
      ...
      ff.position.set(this.visualObject.position.x, this.visualObject.position.y, 0);
      // ff.refreshMatrixes();
      // ff.bbb();
      // debugger
